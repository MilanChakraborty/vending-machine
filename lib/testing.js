...
const updateTestLog = function(result, expected, actual, funcName) {
  testLog.push({
    result : result,
    expected : expected,
    actual : actual,
...
const assert  = function(actual, expected, message, funcName) {
  const result = isSame(actual, expected);
  updateAssertionCount(result);
  updateTestLog(result, expected, actual, funcName);
  console.log(formatAssertionsMessage(result, actual, expected, message));
}

const assertArray  = function(actual, expected, message, funcName) {
...
console.group(groupingTestLog(testLog, "result"));*/
